jest.mock("../../build/exchanger", () => ({
  send: jest.fn(),
}));

const commander = require("../../build/exchanger"),
  controlCommands = require("../../build/commands/control"),
...
describe("control commands", () => {
  ...
  it("should have command for go to position", () => {
    ...
    expect(commander.send).toBeCalledWith(
      `go ${end.x} ${end.y} ${end.z} ${speed}`
    );
  });
